...
public class PnRTCClient {
     ...
     */
    public PnRTCClient(Context context,String pubKey, String subKey) {
        ...
        this.pcClient = new PnPeerConnectionClient(context, this.mPubNub, this.pnSignalingParams, new PnRTCListener() {});
    }
     ...
     */
    public PnRTCClient(Context context, String pubKey, String subKey, String UUID) {
        this.UUID = UUID;
        this.mPubNub  = new Pubnub(pubKey, subKey);
        this.mPubNub.setUUID(this.UUID);
        this.pnSignalingParams = PnSignalingParams.defaultInstance();
