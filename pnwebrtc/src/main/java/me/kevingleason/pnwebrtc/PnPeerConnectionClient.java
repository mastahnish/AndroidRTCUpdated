...
public class PnPeerConnectionClient {
    ...
    public PnPeerConnectionClient(Context context, Pubnub pubnub, PnSignalingParams signalingParams, PnRTCListener rtcListener){
        this.context = context;
        this.mPubNub = pubnub;
        this.signalingParams = signalingParams;
        this.mRtcListener = rtcListener;
        this.pcFactory = createPeerConnectionFactory();
//        new PeerConnectionFactory(); // TODO: Check it allowed, else extra param
